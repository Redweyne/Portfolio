...
export function Contact() {
  ...
  const handleIntentSelect = (preset: string) => {
    setValue("message", preset, { shouldDirty: true });
  };
          ...
          <div className="space-y-6">
            ...
            <div className="sm:hidden">
              <div className="cyber-card overflow-hidden">
                ...
                >
                  <div>
                    <p className="font-mono text-sm text-[#00ffff] tracking-widest">STATUS_CHANNEL</p>
                    <p className="font-mono text-xs text-gray-300 flex items-center gap-2 mt-1">
                      <span className="text-[#00ff66]">UPTIME 99.98%</span>
                      <span className="text-gray-600">•</span>
                      <span className="text-[#00ffff]">SLA &lt;24H RESPONSE</span>
                    </p>
                  </div>
                  <ChevronDown
                    className={`w-4 h-4 text-[#00ffff] transition-transform ${mobileStatusOpen ? "rotate-180" : ""}`}
                  />
                </button>
